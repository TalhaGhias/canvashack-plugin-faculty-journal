...
var canvashack = {
	...
	addMenu: function() {
		var userId = this.facultyJournalUrl.exec(document.location.href)[1];
		var courseId = this.facultyJournalUrl.exec(document.location.href)[2];
		var courseName = this.facultyJournalUrl.exec(document.location.href)[3];
		...
		$('body').bind({
			copy: this.blockClipboard,
			cut: this.blockClipboard
		});
	},
